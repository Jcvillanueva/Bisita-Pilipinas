          ...
          <div class="accordion" id="accordionExample1">
                    ...
                    <div class="mapouter">
                        <div class="gmap_canvas">
                            ...
                            src="https://maps.google.com/maps?q=Mount%20387%20Hiking%20Station&t=k&z=15&ie=UTF8&iwloc=&output=embed" frameborder="1" scrolling="no" marginheight="0" marginwidth="0">
                             ...
                             <br>
                        <style>
                        .mapouter{position:relative;text-align:right;height:355px;width:549px;}
                        </style>
                    </div>
                </div>
            ...
            <div class="accordion-item">
              ...
              <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                ...
                <br>
                    <strong>Description:</strong>
                    <a> After climbing Mount 387, tourists can go directly to Aloha Falls to refresh and de-stress. 
                        The waterfalls in this spot is clear and powerful. 
                        A perfect area to enjoy nature with your friends and family. </a><br>
                    <strong>Location:</strong> 
                    <a> Barangay Puncan, Carranglan, Nueva Ecija </a>
                    <div class="mapouter">
                        <div class="gmap_canvas">
                            ...
                            <style>.mapouter{position:relative;text-align:right;height:355px;width:549px;}</style>
                        </div>
                    </div>
