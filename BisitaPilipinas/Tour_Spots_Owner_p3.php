    ...
    <body>
      ...
      <div class="sidebar">
        ...
        <ul class="nav-list">
         ...
         <li>
           <a href="Tour_Spots_Owner_p3.php">
     ...
     <section class= "home-section">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="./images/Pccpt1.jpg" class="d-block w-100 h-100" alt="...">
                  <div class="carousel-caption d-none d-md-block">
                  <h5>Philippine Carabao Center,</h5>
                      <p>Carranglan Nueva Ecija</p>
                  </div>
                </div>
                <div class="carousel-item">
                <img src="./images/pccpt2.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                <h5>Philippine Carabao Center,</h5>
                      <p>Carranglan Nueva Ecija</p>
                  </div>
                ...
                <div class="carousel-item">
                <img src="./images/pccpt3.png" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                <h5>Philippine Carabao Center,</h5>
                      <p>Carranglan Nueva Ecija</p>
                  </div>
                ...
                <div class="carousel-item">
                <img src="./images/ranch.png" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                <h5>Philippine Carabao Center,</h5>
                      <p>Carranglan Nueva Ecija</p>
                  </div>
                ...
                <div class="carousel-item">
                <img src="./images/ranch2.png" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                <h5>Philippine Carabao Center,</h5>
                      <p>Carranglan Nueva Ecija</p>
                  </div>
        ...
        <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="next">
            ...
            <hr class="featurette-divider" style=" border-top:3px solid #000; border-radius: 5px;">
                    ...
                    <div class="col-md-7">
                        <h2 class="featurette-heading fw-normal lh-1">Philippine Carabao Center, Carranglan Nueva Ecija</h2>
                        <p class="lead">Philippine Carabao Center (PCC) is an agency of the Department of Agriculture that promotes Carabao's products, such as milk, meat, etc. It is also a perfect place to hike while you can see imported carabaos along the way.</p>
                        <p class="lead">Also, you can pick wild fruits and try them while having fun witnessing a sunset or sunrise.</p>
                    </div>
                    <div class="col-md-5">

                    <div class="mapouter">
                      <div class="gmap_canvas">
                        <iframe class="gmap_iframe" width="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=500&amp;height=500&amp;hl=en&amp;q=Phillipine carabao centre farm carranglan Nueva ecija&amp;t=k&amp;z=15&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe><a href="https://formatjson.org/">format json</a>
                        </div>
                        <style>
     ...
     <div class="row">
        ...
        ?>
            <nav aria-label="...">
                  <ul class="pagination">
                    <li class="page-item">
                      <a class="page-link" href="Tour_Spots_Owner_p2.php" style="color:#11101D;">Previous</a>
                    </li>
                    <li class="page-item">
                    <a class="page-link" href="Tour_Spots_Owner.php" style="color: #11101D;">1</a></li>
                    <li class="page-item">
                    <a class="page-link" href="Tour_Spots_Owner_p2.php" style="color:#11101D;">2</a>
                    </li>
                    <li class="page-item active" aria-current="page"><span class="page-link" href="Tour_Spots_Owner_p3.php" style="color: #fff; background-color:#11101D; border-color:#11101D;">3</span></li>
                    <li class="page-item " ><a class="page-link" href="Tour_Spots_Owner_p4.php" style="color: #11101D;" >4</a></li>
                    <li class="page-item">
                      <a class="page-link" href="Tour_Spots_Owner_p4.php"style="color:#11101D;">Next</a>
                    </li>
                  </ul>
                </nav>
        <!-- heading end -->
