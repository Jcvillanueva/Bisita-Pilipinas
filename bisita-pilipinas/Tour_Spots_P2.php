    ...
    <body>
     ...
     <div class="row">
        ...
        <nav aria-label="...">
                  <ul class="pagination">
                    <li class="page-item ">
                      <a class="page-link" href="Tour_Spots.php">Previous</a>
                    </li>
                    <li class="page-item">
                    <a class="page-link" href="Tour_Spots.php">1</a></li>
                    <li class="page-item active" aria-current="page">
                    <span class="page-link" href="Tour_Spots_P2.php" style>2</span>
                    </li>
                    <li class="page-item"><a class="page-link" href="Tour_Spots_p3.php">3</a></li>
                    <li class="page-item">
