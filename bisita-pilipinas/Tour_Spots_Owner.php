    ...
    <body>
     ...
     <section class= "home-section">
        ...
        <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="next">
            ...
            <hr class="featurette-divider" style=" border-top:8px solid #000; border-radius: 15px;">

                    <div class="row featurette">
                    <div class="col-md-7">
                        <h2 class="featurette-heading fw-normal lh-1">Mount 387</h2>
                        <p class="lead">Also known as Batong Amat, mount 387 is a well-known hiking destination located in the province of Nueva Ecija. Tourists will be able to capture the sunrise along with the beauty of the Craballo mountain range. Nearby tourist spots that could be visited along this location is the Aloha Falls.</p>
                        <p class="lead">After climbing Mount 387, tourists can go directly to Aloha Falls to refresh and de-stress. The waterfalls in this spot is clear and powerful – a perfect area to enjot nature with your friends and family.
                    </p>
                    </div>
                    <div class="col-md-5">

                    <div class="mapouter"><div class="gmap_canvas"><iframe class="gmap_iframe" width="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=500&amp;height=500&amp;hl=en&amp;q=mount 387&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe><a href="https://piratebay-proxys.com/">Piratebay</a></div><style>.mapouter{position:relative;text-align:right;width:100%;height:500px;}.gmap_canvas {overflow:hidden;background:none!important;width:100%;height:500px;}.gmap_iframe {height:500px!important;}</style></div>
                    </div>
                    </div>
